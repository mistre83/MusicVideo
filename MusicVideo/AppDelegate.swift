...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func statusChangedWithReachability(currentReachabilityStatys: Reachability) {
        
        let networkStatus: NetworkStatus = currentReachabilityStatys.currentReachabilityStatus()
